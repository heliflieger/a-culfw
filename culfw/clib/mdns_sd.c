...
const char PROGMEM mdns_culfw_service[] = "_culfw._tcp.local";
const char PROGMEM mdns_culfw_name[] = "culfw TCP interface @ " CONF_HOSTNAME;

/* Service List */
static struct mdns_service services[] = {
  { .service = mdns_culfw_service, .name = mdns_culfw_name, .text = NULL, .port = 2323, .state = 0},
